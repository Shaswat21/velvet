...
import { ArrowLeft, Hand, MousePointer2, Type, Image as ImageIcon, Trash2, Square } from "lucide-react";
...
interface HeaderProps {
  ...
  handleAddText: () => void;
  handleAddImage: (e: React.ChangeEvent<HTMLInputElement>) => void; // New prop
